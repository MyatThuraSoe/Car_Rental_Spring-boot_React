...
import CustomerVerificationForm from "./pages/Customer/CustomerVerificationForm";
            ...
            <Router>
                ...
                <div className="container mt-4">
                    <Routes>
                        ...
                        <Route path="/admin/customer-verification-list" element={<CustomerVerificationList/>} />
                        <Route path="/admin/agency-verification-list" element={<AgencyVerificationList/>} />
                        ...
                        <Route path='/agency/upload-verification' element={<AgencyVerificationForm/>}/>
                        ...
                        <Route path='/customer/upload-verification' element={<CustomerVerificationForm/>}/>
